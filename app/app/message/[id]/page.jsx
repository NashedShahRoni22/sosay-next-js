...
export default function MessagingPage() {
  ...
  useEffect(() => {
    if (!userInfo?.id || !selectedUser) return;
    ...
    channel.listen(".message.sent", (e) => {
      ...
      if (e.sender_id === selectedUser.user_id) {
        setChatHistory((prev) => [
          ...prev,
          {
            id: e.id || Date.now(),
  ...
  return (
    <div className="w-full h-screen md:h-[calc(100vh-8rem)] md:max-w-7xl md:mx-auto md:mt-14">
      <div className="grid grid-cols-1 md:grid-cols-12 md:gap-4 h-full">
        {/* Left Sidebar - Message List (Hidden on mobile when chat is open) */}
        <div
          className={`${
            selectedUser ? "hidden md:block" : "block"
          } md:col-span-4 bg-white md:rounded-lg md:shadow p-4 md:p-6 overflow-y-auto h-full`}
        >
          <div className="mb-6">
        ...
        <div
          ...
          } md:col-span-8 bg-white md:rounded-lg md:shadow flex flex-col h-full`}
        >
          {!selectedUser ? (
            ...
            <>
              {/* Chat Header */}
              <div className="border-b p-3 md:p-4 flex items-center space-x-3 sticky top-0 bg-white z-10">
