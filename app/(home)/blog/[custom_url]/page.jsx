  ...
  const fetchBlogDetails = async (url) => {
    ...
    try {
      const res = await fetch(
        `https://api.blog.bfinit.com/api/v1/single_blog_view/${url}`,
      );
  ...
  return (
    <article className="bg-gradient-to-br from-pink-50 via-white to-blue-50 min-h-screen text-gray-900 pt-32 pb-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5">
        ...
        {/* Featured Image */}
        {blog.thumbnail && (
          <div className="relative w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden mb-12 border-4 border-white">
            <Image
              src={blog.thumbnail}
              alt={blog.title}
              fill
